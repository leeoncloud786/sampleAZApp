...
using AzStudentAPp.Models;

namespace AzStudentAPp.Controllers
{
    public class StudentInfoesController : Controller
    {
        private AzSampleStudentsEntities2 db = new AzSampleStudentsEntities2();
        ...
        public ActionResult Create([Bind(Include = "StudentID,StudentName,Gender,Phone,Email,Department")] StudentInfo studentInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,StudentName,Gender,Phone,Email,Department")] StudentInfo studentInfo)
        {
            if (ModelState.IsValid)
            {
